    ...
    <header className="w-full flex flex-col gap-5 pt-4 pb-2">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center flex-wrap gap-3 text-xs md:text-sm font-black uppercase">
          ...
          <button
            onClick={toggleSound}
            className="bg-white border-3 border-black p-2 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:bg-slate-100 active:translate-x-0.5 active:translate-y-0.5 transition-all"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center flex-wrap gap-3">
          ...
          <button
            ...
            className="bg-white border-3 border-black p-2 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:bg-slate-100 transition-all"
            title="How to Play"
          >
